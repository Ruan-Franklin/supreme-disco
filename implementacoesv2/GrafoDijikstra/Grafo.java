import java.util.*;
public class Grafo<TipoVertice, TipoAresta extends Number> implements IGrafo<TipoVertice, TipoAresta>{
  ...
  public boolean temCaminhoEuleriano(){
    ...
    public Map<TipoVertice, Double> dijkstra(TipoVertice origem) {
        ...
        for (TipoVertice v : adjacencias.keySet()) {
        ...
        while (!filaPrioridade.isEmpty()) {
            ...
            for (Aresta<TipoVertice, TipoAresta> aresta : adjacencias.getOrDefault(verticeAtual, Collections.emptySet())) {
                TipoVertice vizinho;
                try {
                    vizinho = this.oposto(verticeAtual, aresta);
                } catch (Exception e) {
                    continue;
                }
